                        ...
                        <div class="description" style="height: 375px;">
                            <p>
                                ...
                                <ul class="sc-case-ul">
                                    ...
                                    <li><a href="<%=request.getContextPath()%>/files/ESA-1D_manual_rus.pdf">Инструкция по эксплуатации</a></li>
                                </ul>
                            </p>
                        </div>
                    </div></li>
            ...
            <div class="portlet">
                ...
                <div class="content description">
                    <ul class="ul-clean ul-li-mb-1em">
                        <li class="first"><a class="pdf" href="<%=request.getContextPath()%>/files/ESA-1D_manual_rus.pdf" target="_blank" title="Инструкция по эксплуатации агрегата ЭСА-1Д">Инструкция по эксплуатации</a></li>
                    </ul>
                </div>
            </div>
