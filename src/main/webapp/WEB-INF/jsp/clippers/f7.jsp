            ...
            <div class="ul-list-two" style="margin-top: 1em;">
                <ul class="ul">
                    <li class="li li-first"><div class="box box-container">
                        <div class="description" style="height: 360px;">
							...
							<p>Остальные характеристики этой машинки, а также комплект поставки, такие же, как у машинки <a href="<%=request.getContextPath()%>/clippers/vs84-s">VS84-S</a>. В отличие от похожей на нее машинки GTS-2012 все зубчатые колеса её редуктора изготовлены из стали, а не из текстолита. Кроме того, электродвигатель машинки F7 более тихий и имеет более высокий коэффициент полезной мощности, что способствует уменьшению нагрева машинки во время работы.</p>
            ...
            <div class="portlet">
                ...
                <div class="content description">
                    <ul class="ul-clean ul-li-mb-1em">
                        <li class="first"><a class="pdf" href="<%=request.getContextPath()%>/files/VS84-S_manual_rus.pdf">Инструкция по применению</a></li>
                    </ul>
                </div>
            </div>
            <c:set var="ta"/>
