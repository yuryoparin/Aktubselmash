        ...
        <div class="main-content-sidebar">
			...
			<div class="box box-container" style="margin-top: 1em;">
                <ul class="vertical-ul">
                    <li>
                        <h2>Описание</h2>
                        <p style="margin-top: 6px;">Для стрижки большого количества овец за сезон (от 50 до 1000 голов) рекомендуем приобретать более мощные (430 Вт) машинки Liscop Super Profi 3000, изготовленные в Германии и имеющиеся у нас в наличии.</p>
