...
<div title="description" class="se-description" style="display: none;">
    Преобразователь частотный Toshiba Япония предназначен для питания двух машинок
            ...
            <div class="gallery" style="float:left; margin-left: 5px; height: 433px; width: 400px;">
                <div class="gallery-box" style="width: 400px;">
                    <ul class="gallery-box-ul" style="width: 840px;">
                        <li><img src="<%=request.getContextPath()%>/images/parts/Toshiba/1b.jpg" alt="Стрижка овец ${productPrice.product.name}" border="0" width="400" height="414"/></li>
                        <li><img src="<%=request.getContextPath()%>/images/parts/Toshiba/2b.jpg" alt="Стрижка овец ${productPrice.product.name}" border="0" width="400" height="414"/></li>
                    </ul>
                </div>
    ...
    <div class="portlet">
        ...
        <div class="content description">
            <ul class="ul-clean ul-li-mb-1em">
                <li class="first"><a class="pdf" href="<%=request.getContextPath()%>/files/PCH-400-2_manual_rus.pdf" title="Инструкция по эксплуатации преобразователя частоты Toshiba">Описание преобразователя частоты тока</a></li>
            </ul>
        </div>
    </div>
    <c:set var="ta"/>
