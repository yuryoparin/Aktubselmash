...
<div title="description" class="se-description" style="display: none;">
  Точильный аппарат ТА-2М предназначен для заточки (доводки) режущих пар
    ...
    <div class="main-content-sidebar">
      ...
      <div class="box box-container" style="margin-top: 1em;">
        <ul class="vertical-ul">
          <li>
            <h2>Описание</h2>
            <p style="margin-top: 12px;">Точильный аппарат ТА-2М является модификацией <a href="<%=request.getContextPath()%>/clippers/ta-2">ТА-2</a>
              с одним установленным диском и уже наклеенной на него наждачной бумагой. Аппарат полностью готов к работе.</p>
          </li>
          <li>
            <h2>Комплектация</h2>
            <ul class="sc-case-ul">
              <li class="first">Точильный аппарат с одним точильным диском и с наклеенной наждачной бумагой &mdash; 1 шт.</li>
              <li>Маятник с державкой и 2-мя тягами &mdash; 1 шт.</li>
