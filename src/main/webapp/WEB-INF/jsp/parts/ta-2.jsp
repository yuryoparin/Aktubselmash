            ...
            <div class="box box-container" style="margin-top: 1em;">
                <ul class="vertical-ul">
                    <li>
                        ...
                        <p>Для умельцев, способных самостоятельно изготовить привод заточного станка, предлагаем по выгодным ценам отдельные детали от ТА-2:
                        ...
                        <p>Стоимость комплекта деталей для сборки станка с двумя точильными дисками без двигателя составит 14 800 руб.</p>
                    </li>
                    <li>
                        <h2>Комплектация</h2>
                        <ul class="sc-case-ul">
