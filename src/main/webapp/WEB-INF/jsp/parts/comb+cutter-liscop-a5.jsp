...
<div title="description" class="se-description" style="display: none;">
    Нож и гребенка Liscop A5 с прямой формой зубьев гребенки, количество зубьев гребенки 13, толщина гребенки 3 мм,
                        ...
                        <div class="gallery" style="float:left; margin-left: 5px; height: 433px; width: 400px;">
                            <div class="gallery-box" style="width: 400px;">
                                <ul class="gallery-box-ul" style="width: 1640px">
                                    <li><img src="<%=request.getContextPath()%>/images/parts/Liscop-A5/1b.jpg" alt="${productPrice.product.name}" border="0" width="400" height="414"/></li>
                                    <li><img src="<%=request.getContextPath()%>/images/parts/Liscop-A5/2b.jpg" alt="${productPrice.product.name}" border="0" width="400" height="414"/></li>
                                    <li><img src="<%=request.getContextPath()%>/images/parts/Liscop-A5/3b.jpg" alt="${productPrice.product.name}" border="0" width="400" height="414"/></li>
                                    <li><img src="<%=request.getContextPath()%>/images/parts/Liscop-A5/4b.jpg" alt="${productPrice.product.name}" border="0" width="400" height="414"/></li>
                                </ul>
                            </div>
