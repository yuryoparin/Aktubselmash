...
<head>
	...
	<meta content="режущая пара +для стрижки овец мсу-200, нож +для стрижки овец мсу-200, гребенка +для стрижки овец мсу-200, куплю гребенку +для стрижки овец мсу-200, отечественные режущие пары" name="keywords">
...
<div title="description" class="se-description" style="display: none;">
    Нож и гребенка для МСУ-200 с прямой формой зубьев гребенки, ширина гребенки 76 мм, количество зубьев гребенки 13, толщина гребенки 3 мм,
                        ...
                        <div class="gallery" style="float:left; margin-left: 5px; height: 433px; width: 400px;">
                            <div class="gallery-box" style="width: 400px;">
                                <ul class="gallery-box-ul" style="width: 1640px">
                                    <li><img src="<%=request.getContextPath()%>/images/parts/MSU-200/1b.jpg" alt="${productPrice.product.name}" border="0" width="400" height="414"/></li>
                                    <li><img src="<%=request.getContextPath()%>/images/parts/MSU-200/2b.jpg" alt="${productPrice.product.name}" border="0" width="400" height="414"/></li>
                                    <li><img src="<%=request.getContextPath()%>/images/parts/MSU-200/3b.jpg" alt="${productPrice.product.name}" border="0" width="400" height="414"/></li>
                                    <li><img src="<%=request.getContextPath()%>/images/parts/MSU-200/4b.jpg" alt="${productPrice.product.name}" border="0" width="400" height="414"/></li>
                                </ul>
                            </div>
