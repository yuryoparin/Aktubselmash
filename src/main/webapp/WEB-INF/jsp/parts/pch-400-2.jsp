	...
	<div id="content">
        <div class="main-content-sidebar">
            <div class="box box-container">
				<h1 style="display:none;">Преобразователь частоты тока для стрижки овец ПЧ-400-2</h1>
                <h1>Преобразователь частоты тока ${productPrice.product.name}</h1>
                <p>
            ...
            <div class="box box-container" style="margin-top: 1em;">
                <div class="description">
                    ...
                    <p style="margin-top: 6px;">
                        ...
                        к обычной сети переменного тока 220 В/50 Гц или 48 Вольт постоянного тока. Для подключения машинок
                        предназначены выходные разъёмы в количестве 2 шт. Отключение и включение преобразователя производится
                    ...
                    <p>
                        ...
                        составляет около 400 Вт, что достаточно для работы двух стригальных машин. В преобразователе не
                        применяется вентилятор для охлаждения, а используется алюминиевый корпус-радиатор, что положительно
                        влияет на надежность его использования в условиях загрязненной шерстью воздушной среды.
                    </p>
                    <p>
