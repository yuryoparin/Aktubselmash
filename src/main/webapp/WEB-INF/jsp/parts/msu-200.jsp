...
<div title="description" class="se-description" style="display: none;">
    МСУ-200 работает только от преобразователя частоты тока, который выдает безопасное 3-х фазное напряжение
    36 В с частотой 200 Гц. В МСУ-200 установлен асинхронный двигатель, работающий без угольных щеток,
    поэтому ею можно работать по 10-12 часов в сутки, не выключая машинку. Звоните по тел. +7 (916) 185 0628 или пишите на <a href="mailto:info@aktubselmash.ru">info@aktubselmash.ru</a>
</div>
<div id="wrapper">
                    ...
                    <li class="li li-first"><div class="box box-container">
                        <div class="description" style="height: 250px;">
                            ...
                            <p style="margin-top: 12px;">В МСУ-200 установлен асинхронный двигатель, работающий без угольных щеток,
                                поэтому ею можно работать по 10&ndash;12 часов в сутки, не выключая машинку. МСУ-200 работает
            ...
            <div class="portlet">
                ...
                <div class="content description">
                    <ul class="ul-clean ul-li-mb-1em">
                        <li class="first"><a class="pdf" href="<%=request.getContextPath()%>/files/ASI_MSU_manual_rus.pdf" target="_blank" title="Инструкция по эксплуацатации машинки для стрижки овец МСУ-200">Инструкция по эксплуатации</a></li>
                    </ul>
                </div>
            </div>
            <c:set var="ta"/>
