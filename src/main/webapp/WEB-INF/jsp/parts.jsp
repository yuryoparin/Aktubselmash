...
<head>
	...
	<title>Запчасти и инструменты для стрижки овец - Актюбсельмаш</title>
	<meta content="Ножи и гребенки, точильный станок для стрижки овец. Продажа по России наложенным платежом или самовывозом." name="description">
