	...
	<div id="content">
        <div class="main-content">
            <div class="box box-container">
                <h1>
                    <span style="float: left;">Оплата</span>
                    ...
                    <ul class="vertical-ul">
                        <li>
                            ...
                            <p>Производится в случае самовывоза из Москвы. Отсутствует комиссия за перевод денег.
                               Стоимость доставки по Москве &mdash; 350 руб.
                            </p>
                        </li>
                        <li>
                            <h2>Наложенным платежом</h2>
                            <p>Оплата наложенным платежом производится курьеру почты EMS после доставки машинки на Ваш адрес.
                            Комиссия за перевод суммы от 5000 до 20000 руб. составит 217 руб. + 2% от суммы перевода, превышающей 5000 руб.
                                При отправке Почтой России комиссия за перевод примерно та же.</p>
                        </li>
                        <li>
                            <h2>Переводом на платежную карточку Maestro &laquo;Momentum&raquo; в любом отделении Сбербанка РФ</h2>
                            <p>Сумма перевода увеличится на 0,75%.
                                Перевод необходимо выполнить на карточку Сбербанка РФ (Московский банк) Maestro &laquo;Momentum&laquo; номер: 676196000472859744
                        ...
                        <li>
                            ...
                            Опариин Виталий Константинович<br/>
                            паспорт 45 04 180464, выдан ОВД &laquo;Текстильщики&raquo; гор. Москвы, 22.10.2002 года.</p>
                        </li>
                        <li>
